      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4">{userData?.name || "John Doe"}</h3>
              <p className="text-gray-400 mb-4">
                {userData?.tagline || "Creating beautiful, functional, and user-friendly web experiences"}
              </p>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                ...
                <p>{userData?.phone || "+1 (555) 123-4567"}</p>
                <p>{userData?.location || "New York, NY, USA"}</p>
              </div>
            </div>
          </div>
          
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} {userData?.name || "John Doe"}. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
